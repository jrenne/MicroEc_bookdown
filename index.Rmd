...
This course has been developed by [Jean-Paul Renne](https://www.jprenne.com). It is illustrated by R codes using various packages that can be obtained from [CRAN](https://cran.r-project.org). This `AEC` package is available on GitHub. To install it, one need to employ the `devtools` library:
